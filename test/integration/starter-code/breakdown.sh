...
${WSK} action delete ${PACKAGE_NAME}/integration-pipeline-slack-with-generic-data | grep -v 'ok'
...
${WSK} action delete ${PACKAGE_NAME}/integration-pipeline-facebook-with-generic-data | grep -v 'ok'
...
${WSK} action delete ${PACKAGE_NAME}/mock-conversation-generic-data | grep -v 'ok'
