...
${WSK} action update --sequence test-pipeline-facebook facebook/receive,starter-code/normalize-facebook-for-conversation,starter-code/pre-conversation,conversation/call-conversation,starter-code/normalize-conversation-for-facebook,starter-code/post-conversation,facebook/post -a web-export true | grep -v 'ok'
${WSK} action update --sequence test-pipeline-context-facebook facebook/receive,starter-code/normalize-facebook-for-conversation,context/load-context,starter-code/pre-conversation,conversation/call-conversation,starter-code/normalize-conversation-for-facebook,starter-code/post-conversation,context/save-context,facebook/post -a web-export true | grep -v 'ok'
